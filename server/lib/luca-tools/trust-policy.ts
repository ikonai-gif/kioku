...
export type LucaToolName =
  ...
  | "luca_calendar_list"
  // Track B — Gemini second-engine delegate. UNTRUSTED: the answer is
  // text generated by an external model from a prompt that may itself
  // include untrusted content; Luca must treat it as data, not orders.
  | "luca_ask_gemini";
